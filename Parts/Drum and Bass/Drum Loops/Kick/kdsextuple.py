...
for beat in range(0, 4 * tl.beats_per_measure * tl.measures):
        ...
        tl.add_note(minorkick, root_freq=54, start_beat=beat+1/6, end_beat=beat+1/6+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+1/3, end_beat=beat+1/3+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+0.5, end_beat=beat+0.5+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+ 2/3, end_beat=beat+2/3+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+5/6, end_beat=beat+5/6+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat, end_beat=beat+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+1/6, end_beat=beat+1/6+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+1/3, end_beat=beat+1/3+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+0.5, end_beat=beat+0.5+0.5)
