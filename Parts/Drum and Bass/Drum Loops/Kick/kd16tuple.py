...
for beat in range(0, 4 * tl.beats_per_measure * tl.measures):
        ...
        tl.add_note(minorkick, root_freq=54, start_beat=beat+1/16, end_beat=beat+1/16+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+0.125, end_beat=beat+1.125+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+3/16, end_beat=beat+3/16+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+0.25, end_beat=beat+0.75)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+5/16, end_beat=beat+5/16+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+0.375, end_beat=beat+1.375+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+7/16, end_beat=beat+7/16+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+0.5, end_beat=beat+1)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+9/16, end_beat=beat+9/16+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+0.625, end_beat=beat+1.625+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+11/16, end_beat=beat+11/16+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+0.75, end_beat=beat+1.25)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+13/16, end_beat=beat+13/16+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+0.875, end_beat=beat+1.875+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+15/16, end_beat=beat+15/16+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat, end_beat=beat+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+1/16, end_beat=beat+1/16+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+0.125, end_beat=beat+1.125+0.5)
        tl.add_note(minorkick, root_freq=54, start_beat=beat+3/16, end_beat=beat+3/16+0.5)
