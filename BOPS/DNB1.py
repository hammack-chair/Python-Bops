...
tl = Timeline(bpm=170, time_signature=(4,4), measures=4, fs=44100)
...
# snare drum loop        
    if beat % 2 == 1:
        tl.add_note(snare3, root_freq=108, start_beat=beat, end_beat=beat+0.5)

# hihat loop
    if beat % 4 == 0:
#        tl.add_note(hihat, root_freq=0, start_beat=beat, end_beat=beat+0.1)
#        tl.add_note(hihat, root_freq=0, start_beat=beat + 0.25, end_beat=beat+0.35)
        tl.add_note(hihat, root_freq=0, start_beat=beat + 0.5, end_beat=beat+0.6)
