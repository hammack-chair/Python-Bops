...
harmsynth_harmonics = [
    # Root
{'type': 'sine', 'interval': chromatic_intervals[0], 'mult': 1, 'amp': 15.5},
{'type': 'sine', 'interval': chromatic_intervals[0], 'mult': 2, 'amp': 0.3456},
{'type': 'sine', 'interval': chromatic_intervals[0], 'mult': 3, 'amp': 2.0368},
...
{'type': 'damped_sine', 'interval': chromatic_intervals[0], 'mult': 1, 'amp': 10.5, 'decay': 2.5},
{'type': 'damped_sine', 'interval': chromatic_intervals[0], 'mult': 3, 'amp': 1.0368, 'decay': 0.5},
# third
{'type': 'triangle', 'interval': chromatic_intervals[4], 'mult': 2, 'amp': 0.012},
...
{'type': 'damped_triangle', 'interval': chromatic_intervals[4], 'mult': 4, 'amp': 0.548, 'decay': 0.5},
{'type': 'damped_triangle', 'interval': chromatic_intervals[4], 'mult': 8, 'amp': 0.424, 'decay': 0.5},
{'type': 'damped_triangle', 'interval': chromatic_intervals[4], 'mult': 16, 'amp': 0.312, 'decay': 0.5},
{'type': 'damped_triangle', 'interval': chromatic_intervals[4], 'mult': 64, 'amp': 0.1024, 'decay': 0.5},

# fifth
{'type': 'sine', 'interval': chromatic_intervals[7], 'mult': 1, 'amp': 0.36},
...
# fifth
{'type': 'damped_sine', 'interval': chromatic_intervals[7], 'mult': 20, 'amp': 0.048, 'decay': 0.5},
{'type': 'damped_sine', 'interval': chromatic_intervals[7], 'mult': 30, 'amp': 0.144, 'decay': 0.5},
]

# Create the instrument
harmsynth = Instrument(harmonics=harmsynth_harmonics, duration=2.0)

# Example usage: play with root 110 Hz (A1)
fs = 44100
root_freq = 1500  # A1
signal, t = harmsynth.synth(root_freq, fs)
