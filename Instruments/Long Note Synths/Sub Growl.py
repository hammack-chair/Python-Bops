...
sub_growl_harmonics = [
    {'type': 'damped_square', 'interval': 1, 'mult': 1, 'amp': 1.0, 'decay': 4.0},
    {'type': 'damped_sawtooth', 'interval': 1, 'mult': 2, 'amp': 0.8, 'decay': 3.5},
    {'type': 'sine', 'interval': 2 ** (7/12), 'mult': 1, 'amp': 0.5},
    {'type': 'triangle', 'interval': 2 ** (3/12), 'mult': 1, 'amp': 0.3},
    {'type': 'damped_triangle', 'interval': 2 ** (-5/12), 'mult': 1, 'amp': 0.2, 'decay': 3.0}
]
