...
maj6synth_harmonics = [
    # Root
    {'type': 'sine', 'interval': chromatic_intervals[0], 'mult': 1, 'amp': 10.5},
...
# third
{'type': 'triangle', 'interval': chromatic_intervals[3], 'mult': 1, 'amp': 0.0},
{'type': 'triangle', 'interval': chromatic_intervals[3], 'mult': 2, 'amp': 0.12},
{'type': 'triangle', 'interval': chromatic_intervals[3], 'mult': 4, 'amp': 0.048},
{'type': 'triangle', 'interval': chromatic_intervals[3], 'mult': 8, 'amp': 0.024},
# fifth
